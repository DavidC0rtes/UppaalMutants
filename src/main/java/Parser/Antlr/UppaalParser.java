...
public class UppaalParser extends Parser {
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case NOT:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & ((1L << (ADD - 96)) | (1L << (SUB - 96)) | (1L << (EXCLAMATION - 96)) | (1L << (NOT - 96)))) != 0)) ) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 84)) & ~0x3f) == 0 && ((1L << (_la - 84)) & ((1L << (ASSIGN - 84)) | (1L << (ASSIGN_COLON - 84)) | (1L << (ASSIGN_ADD - 84)) | (1L << (ASSIGN_SUB - 84)) | (1L << (ASSIGN_MUL - 84)) | (1L << (ASSIGN_DIV - 84)) | (1L << (ASSIGN_PERCENT - 84)) | (1L << (ASSIGN_OR - 84)) | (1L << (ASSIGN_AND - 84)) | (1L << (ASSIGN_XOR - 84)) | (1L << (ASSIGN_LSHIFT - 84)) | (1L << (ASSIGN_RSHIFT - 84)))) != 0)) ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 100)) & ~0x3f) == 0 && ((1L << (_la - 100)) & ((1L << (LESS - 100)) | (1L << (LESSEQ - 100)) | (1L << (COMPARE - 100)) | (1L << (DIFFERENT - 100)) | (1L << (GREATEREQ - 100)) | (1L << (GREATER - 100)))) != 0)) ) {
					...
					case 3:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & ((1L << (COMMA - 80)) | (1L << (ADD - 80)) | (1L << (SUB - 80)) | (1L << (MUL - 80)) | (1L << (DIV - 80)) | (1L << (PERCENT - 80)) | (1L << (BITAND - 80)) | (1L << (BITOR - 80)) | (1L << (BITXOR - 80)) | (1L << (LSHIFT - 80)) | (1L << (RSHIFT - 80)) | (1L << (AND_SYMBOL - 80)) | (1L << (OR_SYMBOL - 80)) | (1L << (MINIMUM - 80)) | (1L << (MAXIMUM - 80)) | (1L << (OR - 80)) | (1L << (AND - 80)) | (1L << (IMPLY - 80)))) != 0)) ) {
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (NAT - 63)) | (1L << (POINT - 63)) | (1L << (LEFT_PARENTHESIS - 63)) | (1L << (INCREMENT - 63)) | (1L << (DECREMENT - 63)) | (1L << (ADD - 63)) | (1L << (SUB - 63)) | (1L << (EXCLAMATION - 63)) | (1L << (NOT - 63)) | (1L << (FORALL - 63)) | (1L << (EXISTS - 63)) | (1L << (SUM - 63)))) != 0) || ((((_la - 139)) & ~0x3f) == 0 && ((1L << (_la - 139)) & ((1L << (TRUE - 139)) | (1L << (FALSE - 139)) | (1L << (IDENTIFIER - 139)))) != 0)) {
				{
				setState(364);
				expr(0);
				setState(369);
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & ((1L << (URGENT - 127)) | (1L << (BROADCAST - 127)) | (1L << (META - 127)) | (1L << (CONST - 127)))) != 0)) {
				{
				setState(387);
				prefix();
				}
		...
		try {
			...
			case 9:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( ((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & ((1L << (URGENT - 127)) | (1L << (BROADCAST - 127)) | (1L << (META - 127)) | (1L << (CONST - 127)) | (1L << (INT - 127)) | (1L << (DOUBLE - 127)) | (1L << (CLOCK - 127)) | (1L << (CHAN - 127)) | (1L << (BOOL - 127)) | (1L << (SCALAR - 127)) | (1L << (STRUCT - 127)) | (1L << (IDENTIFIER - 127)))) != 0) );
				setState(423);
				match(RIGHT_BRACE);
				}
				break;
	...
	public final FuncParametersContext funcParameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & ((1L << (URGENT - 127)) | (1L << (BROADCAST - 127)) | (1L << (META - 127)) | (1L << (CONST - 127)) | (1L << (INT - 127)) | (1L << (DOUBLE - 127)) | (1L << (CLOCK - 127)) | (1L << (CHAN - 127)) | (1L << (BOOL - 127)) | (1L << (SCALAR - 127)) | (1L << (STRUCT - 127)) | (1L << (IDENTIFIER - 127)))) != 0)) {
				{
				setState(501);
				funcParameter();
				setState(506);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (NAT - 63)) | (1L << (POINT - 63)) | (1L << (FOR - 63)) | (1L << (WHILE - 63)) | (1L << (DO - 63)) | (1L << (IF - 63)) | (1L << (RETURN - 63)) | (1L << (LEFT_PARENTHESIS - 63)) | (1L << (LEFT_BRACE - 63)) | (1L << (SEMICOLON - 63)) | (1L << (INCREMENT - 63)) | (1L << (DECREMENT - 63)) | (1L << (ADD - 63)) | (1L << (SUB - 63)) | (1L << (EXCLAMATION - 63)) | (1L << (NOT - 63)) | (1L << (FORALL - 63)) | (1L << (EXISTS - 63)) | (1L << (SUM - 63)))) != 0) || ((((_la - 139)) & ~0x3f) == 0 && ((1L << (_la - 139)) & ((1L << (TRUE - 139)) | (1L << (FALSE - 139)) | (1L << (IDENTIFIER - 139)))) != 0)) {
				{
				{
				setState(519);
				statement();
