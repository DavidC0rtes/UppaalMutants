...
import Utils.VisitorHelper;

import java.util.*;
import java.util.regex.Pattern;

public class UppaalVisitor extends UppaalParserBaseVisitor<String> implements VisitorHelper {


    private int tmiOperator = 0;
    private int indexCurrentTransition = 0;

    private String templateTad = "";
